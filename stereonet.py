...
class Stereonet:
    ...
    def __init__(self, iface):
        ...
        self.actions = []
        self.menu = self.tr(u'&Stereonet')
        # TODO: We are going to let the user set this up in a future iteration
        self.toolbar = self.iface.addToolBar(u'Stereonet')
        self.toolbar.setObjectName(u'Stereonet')
    ...
    def tr(self, message):
        ...
        return QCoreApplication.translate('Stereonet', message)
    ...
    def initGui(self):
        ...
        icon_path = ':/plugins/Stereonet/icon.png'
        self.add_action(
            icon_path,
